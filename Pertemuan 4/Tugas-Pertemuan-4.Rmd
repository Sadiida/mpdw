...
### Kesimpulan
Berdasarkan perbandingan nilai autokorelasi empiris dan teoritis pada model MA(2), yaitu ρ₁ = –0.035 vs –0.105, ρ₂ = –0.44 vs –0.395, dan ρ₃ = –0.122 vs 0, terlihat bahwa meskipun nilai-nilainya cukup mendekati secara kuantitatif, terdapat ketidaksesuaian pola—terutama pada ρ₃ yang seharusnya nol—sehingga model MA(2) menunjukkan kecocokan parsial (MA(2) mungkin menangkap sebagian dinamika data, tapi tidak cukup untuk menjelaskan keseluruhan pola korelasi.) terhadap data bangkitan, namun belum sepenuhnya konsisten secara struktural.
...
>>>>>>> 91b7f7992a74b84a31b6604c45f800fe66c6b3a4
